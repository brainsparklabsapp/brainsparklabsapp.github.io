...
window.___jsl.h=window.___jsl.h||'m;\/_\/apps-static\/_\/js\/gapi\/__features__\/rt=j\/ver=I8IktHNc9tU.en_US.\/sv=1\/am=!Dxyecr_OdryIOx012g\/d=1\/';
window.___jsl.l=[];
window.___gpq=[];
...
window.gapi.plus=window.gapi.plus||(function(){
  ...
  return{go:f('go'),render:f('render')}})();
window['___jsl'] = window['___jsl'] || {};window['___jsl']['uc'] = 'https:\/\/web.archive.org\/web\/20120218200149\/https:\/\/apis.google.com\/js\/plusone.js';window['___jsl']['u'] = 'https:\/\/web.archive.org\/web\/20120218200149\/https:\/\/apis.google.com\/js\/plusone.js';window['___jsl']['f'] = ['plusone-unsupported'];window['___jsl']['ms'] = 'https://web.archive.org/web/20120218200149/https://apis.google.com/';(window['___jsl']['ci'] = (window['___jsl']['ci'] || [])).push({"lexps":[17,33,38,36,7,40,41,47,28,44,15,45],"report":{},"isPlusUser":false});var gapi=window.gapi||{};gapi.client=window.gapi&&window.gapi.client||{};
window.gapi=window.gapi||{};
(function(){var A=void 0,B=void 0,C="___jsl",U="h",D="l",V="m",E="ms",W="ci",X="cu",Y="c",Z="cm",$="o",n="p",o="q",F="lc",G="Q",s="I",t="il",u="_",v="https://web.archive.org/web/20120218200149/https://ssl.gstatic.com/",aa="/webclient/js",ba="/webclient/jsx/",H="https://web.archive.org/web/20120218200149/https://apis.google.com/",I=".js",ca="gcjs-3p",da=/^(https?:)?\/\/([^/:@]*)(:[0-9]+)?(\/[\w.,:!=/-]*)(\?[^#]*)?(#.*)?$/,J=/^[?#]([^&]*&)*jsh=([^&]*)/,K="d",p="r",ea="f",q="m",L="n",fa="sync",ga="callback",ha="config",ia="_ci",w="nodep",M="gapi.load: ",N=function(a,b){A&&A(a,b);throw M+
...
/*
     FILE ARCHIVED ON 20:01:49 Feb 18, 2012 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:18:43 Oct 14, 2019.
...
playback timings (ms):
  ...
  CDXLines.iter: 93.006 (3)
  esindex: 0.011
  PetaboxLoader3.datanode: 140.069 (7)
  load_resource: 607.581
  PetaboxLoader3.resolve: 543.881
  RedisCDXSource: 74.8
  LoadShardBlock: 104.085 (6)
*/